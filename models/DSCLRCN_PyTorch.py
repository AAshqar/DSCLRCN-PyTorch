...
class DSCLRCN(nn.Module):
    ...
    def __init__(self, input_dim=(96, 128), LSTMs_input_size=(256*12, 256*16)):#, LSTM_hs=256):
        ...
        self.fc_h = nn.Linear(256, LSTMs_input_size[0])
        self.fc_v = nn.Linear(256, 2*LSTMs_input_size[1])
    ...
    def forward(self, x):
        ...
        output_h1 = output_h1.contiguous().view(N, 256, H_lf, W_lf)
        
        #print('2nd LSTM')
        output_h2, hz2 = self.lstm_h(local_feats_h2)
        output_h2 = output_h2[:,1:,:]
        output_h2 = output_h2.contiguous().view(N, 256, H_lf, W_lf)
        ...
        output_h12v1 = output_h12v1.contiguous().view(N, 2*256, H_lf, W_lf)
        
        #print('4th LSTM')
        output_h12v2, hz4 = self.lstm_v(output_h12v2)
        output_h12v2 = output_h12v2[:,1:,:]
        output_h12v2 = output_h12v2.contiguous().view(N, 2*256, H_lf, W_lf)
